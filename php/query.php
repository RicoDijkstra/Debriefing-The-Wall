...
foreach ($database->query($sql) as $image_results) {
    ...
    <div class="galleryItem">
        <img class="galleryItemImg modalButton" src="images/<?php echo $image_results['names']; ?>"alt="Picture: <?php echo $image_results['title']; ?>"/>
        <h3 class="galleryItemTitle"><?php echo $image_results['title'];?></h3>
        <div class="modalContent">

            <div class="modalItemTitle">
                <h1><?php echo $image_results['title'];?></h1>
            </div>

            <div class="modalItemRight">
                <div class="modalItemImg">
                    <img src="images/<?php echo $image_results['names'];?>"alt="Picture: <?php echo $image_results['title'];?>">
                </div>
            </div>
